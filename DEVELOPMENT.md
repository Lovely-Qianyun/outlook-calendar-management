...
- 文档命名约定：README.md 为英文默认落地页，README.zh-CN.md 为中文页（页顶互挂语言切换）；SKILL.md 为英文默认 agent 手册，SKILL.zh-CN.md 为中文镜像（frontmatter description 为英文以便市场读取；正文含输出语言检测指令）；英文/中文文档以 `_EN` / `.zh-CN` 后缀成对维护。
